...
import { isArrayType, isBrsFile, isClassStatement, isConstStatement, isCustomType, isDynamicType, isEnumStatement, isFunctionStatement, isFunctionType, isInterfaceStatement, isInterfaceType, isInvalidType, isMethodStatement, isTypedFunctionType, isVariableExpression, isXmlFile } from './astUtils/reflection';
        ...
        if (isBrsFile(file)) {
            for (let expCall of file.functionCalls) {
                ...
                if (isFunctionType(funcType)) {
                    ...
                    this.diagnostics.push({
                        ...DiagnosticMessages.cannotFindName(functionNameText, this.name),
