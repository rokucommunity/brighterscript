    ...
    private walk() {
        ...
        const visitor = createVisitor({
            ...
            FunctionParameterExpression: (node) => {
                if (isTypedFunctionType(node.parent)) {
                    return;
                }
