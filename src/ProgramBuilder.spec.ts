...
describe('ProgramBuilder', () => {
    ...
    describe('run', () => {
        ...
        it('only adds the last file with the same pkg path', async () => {
            ...
            expect(builder.program.getFileBySrcPath(s``));
        });
    });
    ...
    describe('printDiagnostics', () => {
        ...
        it('prints diagnostic, when file is present in project', () => {
            ...
            sinon.stub(builder.program, 'getFileBySrcPath').returns(f1);
    ...
    it('prints diagnostic, when no file present', () => {
        ...
        sinon.stub(builder.program, 'getFileBySrcPath').returns(null);
