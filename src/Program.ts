...
import type { BsDiagnostic, File, FileReference, FileObj, BscFile, SemanticToken, BeforeProvideCompletionsEvent } from './interfaces';
...
export class Program {
    ...
    public getCompletions(pathAbsolute: string, position: Position) {
        ...
        const event: BeforeProvideCompletionsEvent = {
            program: this,
            file: file,
            scopes: scopes,
            position: position,
