...
export function isSpreadExpression(element: AstNode | undefined): element is SpreadExpression {
    return element?.kind === AstNodeKind.SpreadExpression;
}
