...
describe('reflection', () => {
    ...
    describe('Statements', () => {
        ...
        const funs = new FunctionStatement(ident, new FunctionExpression(ident, [], block, token, token, token, token), undefined);
    ...
    describe('Expressions', () => {
        ...
        const fun = new FunctionExpression(ident, [], block, token, token, token, token);
