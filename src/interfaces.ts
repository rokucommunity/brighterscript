import type { Range, Diagnostic, CodeAction, Position, CompletionItem, Location, LocationLink, DocumentSymbol, WorkspaceSymbol, Disposable, FileChangeType, SelectionRange, InlayHint } from 'vscode-languageserver-protocol';
