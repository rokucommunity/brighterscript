export enum TokenKind {
    ...
    SourceNamespaceLiteral = 'SourceNamespaceLiteral',
    SourceNamespaceRootLiteral = 'SourceNamespaceRootLiteral',
...
export const Keywords: Record<string, TokenKind> = {
    ...
    'source_namespace': TokenKind.SourceNamespaceLiteral,
    'source_namespace_root': TokenKind.SourceNamespaceRootLiteral,
...
export const AllowedProperties = [
    ...
    TokenKind.SourceNamespaceLiteral,
    TokenKind.SourceNamespaceRootLiteral,
